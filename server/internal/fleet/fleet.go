...
// ⚡ Bolt: GetStats calculates aggregate status statistics in a single pass without copying models.AgentDetails structs.
// This prevents O(N) slice allocation when counting statuses across the fleet.
