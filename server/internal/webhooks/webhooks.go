...
func sendWebhook(targetURL string, payload WebhookPayload) {
	...
	// #nosec G704 -- Target URL is validated and controlled via environment variables
	...
	if resp.StatusCode >= 400 {
		// #nosec G706 -- StatusCode is an integer, safe to log
...
func NotifySlack(webhookURL string, msg string) {
	...
	// #nosec G107 -- Target URL is validated
