...
The easiest way to start is using Docker Compose. First, create an `.env` file from the example and set your secrets:

```bash
cp .env.example .env
# Edit .env and set POSTGRES_PASSWORD, JWT_SECRET, and REGISTRATION_SECRET
docker-compose up -d
```
