...
The easiest way to start is using Docker Compose. First, configure your secrets:
...
# POSTGRES_PASSWORD, JWT_SECRET, REGISTRATION_SECRET are REQUIRED.
# (Use your favorite text editor to modify .env)
